...
for(const file of await readdir('dist'))if(/^app-.*\.js$/.test(file)&&file!=='app-a07-focused.js')await unlink('dist/'+file);
...
await copyFile('dist/app.js','dist/app-a07-focused.js');
