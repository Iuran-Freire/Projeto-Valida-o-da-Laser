...
- Guarda UUID, data UTC, inspetor, turno informado, conteúdo original e utilizado, séries extraídas, origem, formato, confiança OCR, indicação de edição, confirmação visual, versão da regra e foto JPEG vinculada ao UUID.
