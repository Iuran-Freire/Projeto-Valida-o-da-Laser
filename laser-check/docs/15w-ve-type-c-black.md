...
Escopo confirmado pelo inspetor: usar somente o SEC CODE `GH44-03247A` (BLACK). Na operação atual, o turno segue as letras G/H/J que o aplicativo já usava; as outras letras da tabela ficam fora da validação por enquanto. A medição no canto superior esquerdo da arte e o modelo WHITE também ficam fora desta validação.
